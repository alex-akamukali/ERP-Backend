...
class MakeRepositoryControllerCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'make:repository-controller {name} {--path=} {--repository=}';
...
class ' . $name . 'Controller extends Controller
{
    ...
    {
        return $' . $repositoryInstanceName . '->fetch(request()->all())->get();
    }
    ...
    {
        return $' . $repositoryInstanceName . '->fetchById($id);
    }
