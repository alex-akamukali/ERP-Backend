<script context="module">
    ...
    import MessageNotification from "./MessageNotification.svelte"; //Pages/Components/MessageNotification.svelte";
    // import {notifications} from "../../../../Stores/GlobalStore";
    import {notifications} from "./GlobalStore.js";
    //
</script>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li>
                            <a href="ACCOUNTFTEPayment">
                                <i class="fa fa-money text-blue" /> FTE Payment
                            </a>
                        </li>
                    </ul>
                </li>
